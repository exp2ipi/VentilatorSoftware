...
There is currently one protyotype on the test server, accessible at `/dev/ttyACM0`.

Some components in the testing prototypes may be modified to facilitate testing. 
...
The following Posifa sensors are being considered:
* PMF4103V
* PMF4103D

But they may not become available from manufacturer until the end of June.
